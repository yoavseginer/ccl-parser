...
CTBInitPunctTransTable()
{
    ...
    { static char s[] = {(char)0x74,(char)0x77,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xb6,0};
        CTBPunctTransTable[s] = eLeftSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xaa,0};
        CTBPunctTransTable[s] = eDash; }
    { static char s[] = {(char)0x2d,(char)0x2d,(char)0x2d,(char)0x2d,0};
        CTBPunctTransTable[s] = eDash; }
    { static char s[] = {(char)0xa3,(char)0xad,(char)0xa3,(char)0xad,0};
        CTBPunctTransTable[s] = eDash; }
    { static char s[] = {(char)0x2f,(char)0x2f,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xaf,0};
        CTBPunctTransTable[s] = eRightSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xb1,0};
        CTBPunctTransTable[s] = eRightDoubleQuote; }
    { static char s[] = {(char)0xa1,(char)0xa1,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0x2c,0};
        CTBPunctTransTable[s] = eComma; }
    { static char s[] = {(char)0xa1,(char)0xaa,(char)0xa1,(char)0xaa,0};
        CTBPunctTransTable[s] = eDash; }
    { static char s[] = {(char)0xa3,(char)0xaf,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa3,(char)0xa9,0};
        CTBPunctTransTable[s] = eRightParenthesis; }
    { static char s[] = {(char)0xa3,(char)0xae,0};
        CTBPunctTransTable[s] = eComma; }
    { static char s[] = {(char)0xa1,(char)0xaa,(char)0xa1,(char)0xaa,(char)0xa1,(char)0xaa,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa9,(char)0xa5,(char)0xa9,(char)0xa5,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0x3a,0};
        CTBPunctTransTable[s] = eColon; }
    { static char s[] = {(char)0xa3,(char)0xba,0};
        CTBPunctTransTable[s] = eColon; }
    { static char s[] = {(char)0xa1,(char)0xad,0};
        CTBPunctTransTable[s] = eEllipsis; }
    { static char s[] = {(char)0xa3,(char)0xa1,0};
        CTBPunctTransTable[s] = eExclamation; }
    { static char s[] = {(char)0xa3,(char)0xa7,0};
        CTBPunctTransTable[s] = eRightSingleQuote; }
    { static char s[] = {(char)0xa3,(char)0xa2,0};
        CTBPunctTransTable[s] = eRightDoubleQuote; }
    { static char s[] = {(char)0xa1,(char)0xad,(char)0xa1,(char)0xad,0};
        CTBPunctTransTable[s] = eEllipsis; }
    { static char s[] = {(char)0xa1,(char)0xa3,0};
        CTBPunctTransTable[s] = eFullStop; }
    { static char s[] = {(char)0xa1,(char)0xa4,0};
        CTBPunctTransTable[s] = eFullStop; }
    { static char s[] = {(char)0xa3,(char)0xbf,0};
        CTBPunctTransTable[s] = eQuestion; }
    { static char s[] = {(char)0x33,(char)0x33,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xb9,0};
        CTBPunctTransTable[s] = eRightSingleQuote; }
    { static char s[] = {(char)0xa3,(char)0xac,0};
        CTBPunctTransTable[s] = eComma; }
    { static char s[] = {(char)0xa3,(char)0xbe,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa3,(char)0xad,0};
        CTBPunctTransTable[s] = eDash; }
    { static char s[] = {(char)0xa1,(char)0xbf,0};
        CTBPunctTransTable[s] = eRightSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xba,0};
        CTBPunctTransTable[s] = eLeftSingleQuote; }
    { static char s[] = {(char)0x2d,0};
        CTBPunctTransTable[s] = eDash; }
    { static char s[] = {(char)0xa3,(char)0xa8,0};
        CTBPunctTransTable[s] = eLeftParenthesis; }
    { static char s[] = {(char)0xa1,(char)0xa1,(char)0x2a,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0x2f,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0x21,0};
        CTBPunctTransTable[s] = eExclamation; }
    { static char s[] = {(char)0x2a,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xab,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0x7e,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xb0,0};
        CTBPunctTransTable[s] = eLeftDoubleQuote; }
    { static char s[] = {(char)0xa9,(char)0xa5,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa3,(char)0xbc,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa9,(char)0xa4,(char)0xa9,(char)0xa4,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xb5,0};
        CTBPunctTransTable[s] = eRightSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xbb,0};
        CTBPunctTransTable[s] = eRightSingleQuote; }
    { static char s[] = {(char)0xb0,(char)0xeb,(char)0xd1,(char)0xa8,(char)0xca,(char)0xbd,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xb4,0};
        CTBPunctTransTable[s] = eLeftSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xc3,0};
        CTBPunctTransTable[s] = eColon; }
    { static char s[] = {(char)0x2e,0};
        CTBPunctTransTable[s] = eFullStop; }
    { static char s[] = {(char)0xa3,(char)0xaa,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0xa1,(char)0xb8,0};
        CTBPunctTransTable[s] = eLeftSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xaa,(char)0xa3,(char)0xad,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0x3f,0};
        CTBPunctTransTable[s] = eQuestion; }
    { static char s[] = {(char)0xa1,(char)0xb7,0};
        CTBPunctTransTable[s] = eRightSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xbe,0};
        CTBPunctTransTable[s] = eLeftSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xae,0};
        CTBPunctTransTable[s] = eLeftSingleQuote; }
    { static char s[] = {(char)0xa3,(char)0xa6,0};
        CTBPunctTransTable[s] = eNoPunct; }
    { static char s[] = {(char)0x60,0};
        CTBPunctTransTable[s] = eLeftSingleQuote; }
    { static char s[] = {(char)0xa1,(char)0xa2,0};
        CTBPunctTransTable[s] = eComma; }
    { static char s[] = {(char)0xa3,(char)0xbb,0};
